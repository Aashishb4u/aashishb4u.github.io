...
var Profile = (function () {
    function Profile(router, adminServices, fb, authentication, appService, toastr, vRef, _spinner) {
        this.router = router;
    ...
    // }
    Profile.prototype.userBasicInfo = function () {
        var _this = this;
        ...
        this.changePasswordForm = this.fb.group({
            'password': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(8), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].maxLength(16)])],
     ...
     */
    Profile.prototype.setUserData = function (userData) {
    ...
    Profile.prototype.triggers = function () {
        this.fileUpload.nativeElement.click();
    };
    /**
     * Function to load image.
     */
    Profile.prototype.fileChangeListener = function ($event) {
        var _this = this;
        var image = new Image();
    ...
    Profile.prototype.previewImage = function (src) {
        this.form.controls['profile_img'].patchValue(src);
        this.imageUrl = src;
    };
    //onSubmit
    Profile.prototype.onSubmit = function (value) {
        var _this = this;
    ...
    Profile.prototype.getUserProfileDetails = function () {
        var _this = this;
    ...
    Profile.prototype.getUserProfileSuccess = function (resultantUserData) {
        var userData = resultantUserData.success.data.user;
        this.setUserData(userData);
    };
    //if get user profile fail
    Profile.prototype.getUserProfileFail = function (err) {
    ...
    Profile.prototype.editProfileSuccess = function (profileData) {
    ...
    Profile.prototype.editProfileFail = function (err) {
        this._spinner.hide();
        if (err.error && err.error.message) {
            this.toastr.error(err.error.message);
        }
     ...
     */
    Profile.prototype.onChangePasswordSubmit = function (data) {
        var _this = this;
        this._spinner.show();
    ...
    Profile.prototype.changePasswordSuccess = function (result) {
        this._spinner.hide();
    ...
    Profile.prototype.changePasswordFail = function (err) {
        this._spinner.hide();
        if (err.error && err.error.message) {
            this.toastr.error(err.error.message);
        }
    ...
    Profile.prototype.changeTab = function (id) {
        if (id == "password") {
            this.passwordComponent = true;
            this.settingComponent = false;
            this.notificationComponent = false;
    ...
    Profile.prototype.trimContent = function (value, control) {
        if (value) {
...
], Profile.prototype, "fileUpload", void 0);
__decorate([
...
], Profile.prototype, "confirmUserChangePasswordModal", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])('firstName'),
    __metadata("design:type", Object)
], Profile.prototype, "firstField", void 0);
Profile = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'profile',
        encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
        styles: [__webpack_require__("../../../../../src/app/pages/Profile/profile.scss")],
        template: __webpack_require__("../../../../../src/app/pages/Profile/profile.html")
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__profile_routing__ = __webpack_require__("../../../../../src/app/pages/Profile/profile.routing.ts");
...
ProfileModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__profile_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__profile_component__["a" /* Profile */]
        ],
        providers: []
    })
], ProfileModule);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__profile_component__["a" /* Profile */],
        children: []
    }
];
