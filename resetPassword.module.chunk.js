...
var resetPassword = (function (_super) {
    ...
    function resetPassword(fb, router, appService, toastr, vRef, _spinner, authentication) {
        ...
        _this.form = fb.group({
            'confirmResetCode': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].required])],
            'passwords': fb.group({
                ...
                'confirmPassword': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].minLength(8)])]
            }, { validator: __WEBPACK_IMPORTED_MODULE_6__theme_validators__["b" /* EqualPasswordsValidator */].validate('password', 'confirmPassword') })
        });
        return _this;
    }
    //onSubmit
    resetPassword.prototype.onSubmit = function (values) {
        var _this = this;
        ...
        this.appService.forgotPassword(resetPasswordData).subscribe(function (data) { return _this.forgotPasswordSuccess(data); }, function (error) { return _this.forgotPasswordFail(error); });
    };
    resetPassword.prototype.ngAfterViewInit = function () {
        this.confirmationCode.first.nativeElement.focus();
    };
    resetPassword.prototype.forgotPasswordSuccess = function (data) {
        this.router.navigate(['/login']);
        this.toastr.success(data.success.data.message);
    };
    resetPassword.prototype.forgotPasswordFail = function (Error) {
    ...
    resetPassword.prototype.navigateToHome = function () {
        this.router.navigate(['']);
    };
    resetPassword.prototype.navigateToSignIn = function () {
        this.router.navigate(['/login']);
    };
...
], resetPassword.prototype, "confirmationCode", void 0);
resetPassword = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'resetPassword',
        encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
        template: __webpack_require__("./src/app/pages/resetPassword/resetPassword.html"),
        styles: [__webpack_require__("./src/app/pages/resetPassword/resetPassword.scss")]
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resetPassword_component__ = __webpack_require__("./src/app/pages/resetPassword/resetPassword.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__resetPassword_routing__ = __webpack_require__("./src/app/pages/resetPassword/resetPassword.routing.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ResetPasswordModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__resetPassword_routing__["a" /* routing */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__resetPassword_component__["a" /* resetPassword */]
        ]
    })
], ResetPasswordModule);
...
/***/ "./src/app/pages/resetPassword/resetPassword.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resetPassword_component__ = __webpack_require__("./src/app/pages/resetPassword/resetPassword.component.ts");


var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__resetPassword_component__["a" /* resetPassword */]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["c" /* RouterModule */].forChild(routes);
//# sourceMappingURL=resetPassword.routing.js.map

/***/ }),

/***/ "./src/app/pages/resetPassword/resetPassword.scss":
/***/ (function(module, exports) {

module.exports = ".auth-main {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  height: 100%;\n  width: 100%;\n  position: absolute; }\n\n.auth-block {\n  width: 540px;\n  margin: 0 auto;\n  border-radius: 5px;\n  background: rgba(0, 0, 0, 0.55);\n  color: #fff;\n  padding: 32px; }\n\n.auth-block h1 {\n    font-weight: 300;\n    margin-bottom: 28px;\n    text-align: center; }\n\n.auth-block p {\n    font-size: 16px; }\n\n.auth-block a {\n    text-decoration: none;\n    outline: none;\n    -webkit-transition: all 0.2s ease;\n    transition: all 0.2s ease;\n    color: #374767; }\n\n.auth-block a:hover {\n      color: #2f3c58; }\n\n.auth-block .control-label {\n    padding-top: 11px;\n    color: #ffffff; }\n\n.auth-block .form-group {\n    margin-bottom: 12px; }\n\n.auth-input {\n  width: 300px;\n  margin-bottom: 24px; }\n\n.auth-input input {\n    display: block;\n    width: 100%;\n    border: none;\n    font-size: 16px;\n    padding: 4px 10px;\n    outline: none; }\n\na.forgot-pass {\n  display: block;\n  text-align: right;\n  margin-bottom: -20px;\n  float: right;\n  z-index: 2;\n  position: relative; }\n\n.auth-link {\n  display: block;\n  font-size: 16px;\n  text-align: center;\n  margin-bottom: 33px; }\n\n.auth-sep {\n  margin-top: 36px;\n  margin-bottom: 24px;\n  line-height: 20px;\n  font-size: 16px;\n  text-align: center;\n  display: block;\n  position: relative; }\n\n.auth-sep > span {\n    display: table-cell;\n    width: 30%;\n    white-space: nowrap;\n    padding: 0 24px;\n    color: #ffffff; }\n\n.auth-sep > span > span {\n      margin-top: -12px;\n      display: block; }\n\n.auth-sep:before, .auth-sep:after {\n    border-top: solid 1px #ffffff;\n    content: \"\";\n    height: 1px;\n    width: 35%;\n    display: table-cell; }\n\n.al-share-auth {\n  text-align: center; }\n\n.al-share-auth .al-share {\n    float: none;\n    margin: 0;\n    padding: 0;\n    display: inline-block; }\n\n.al-share-auth .al-share li {\n      margin-left: 24px; }\n\n.al-share-auth .al-share li:first-child {\n        margin-left: 0; }\n\n.al-share-auth .al-share li i {\n        font-size: 24px; }\n\nbody {\n  font-family: 'Conv_Avenir'; }\n\n.auth-main {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  height: 100%;\n  width: 100%;\n  position: absolute; }\n\n.auth-block {\n  width: 540px;\n  margin: 0 auto;\n  border-radius: 5px;\n  background: rgba(0, 0, 0, 0.55);\n  color: #fff;\n  padding: 32px; }\n\n.auth-block h1 {\n    font-weight: 300;\n    margin-bottom: 28px;\n    text-align: center; }\n\n.auth-block p {\n    font-size: 16px; }\n\n.auth-block a {\n    text-decoration: none;\n    outline: none;\n    -webkit-transition: all 0.2s ease;\n    transition: all 0.2s ease;\n    color: #374767; }\n\n.auth-block a:hover {\n      color: #2f3c58; }\n\n.auth-block .control-label {\n    padding-top: 11px;\n    color: #ffffff; }\n\n.auth-block .form-group {\n    margin-bottom: 12px; }\n\n.auth-input {\n  width: 300px;\n  margin-bottom: 24px; }\n\n.auth-input input {\n    display: block;\n    width: 100%;\n    border: none;\n    font-size: 16px;\n    padding: 4px 10px;\n    outline: none; }\n\na.forgot-pass {\n  display: block;\n  text-align: right;\n  margin-bottom: -20px;\n  float: right;\n  z-index: 2;\n  position: relative; }\n\n.auth-link {\n  display: block;\n  font-size: 16px;\n  text-align: center;\n  margin-bottom: 33px; }\n\n.auth-sep {\n  margin-top: 36px;\n  margin-bottom: 24px;\n  line-height: 20px;\n  font-size: 16px;\n  text-align: center;\n  display: block;\n  position: relative; }\n\n.auth-sep > span {\n    display: table-cell;\n    width: 30%;\n    white-space: nowrap;\n    padding: 0 24px;\n    color: #ffffff; }\n\n.auth-sep > span > span {\n      margin-top: -12px;\n      display: block; }\n\n.auth-sep:before, .auth-sep:after {\n    border-top: solid 1px #ffffff;\n    content: \"\";\n    height: 1px;\n    width: 35%;\n    display: table-cell; }\n\n.al-share-auth {\n  text-align: center; }\n\n.al-share-auth .al-share {\n    float: none;\n    margin: 0;\n    padding: 0;\n    display: inline-block; }\n\n.al-share-auth .al-share li {\n      margin-left: 24px; }\n\n.al-share-auth .al-share li:first-child {\n        margin-left: 0; }\n\n.al-share-auth .al-share li i {\n        font-size: 24px; }\n\nbody {\n  font-family: 'Conv_Avenir'; }\n\n.paginationControl {\n  width: 100%;\n  float: left;\n  padding: 0 15px; }\n\n.paginationControl #listItem .ngx-pagination .current {\n    background: #195C94;\n    color: #fff; }\n\n.paginationControl #listItem .ngx-pagination .pagination-previous {\n    border-bottom-left-radius: 3px;\n    border-top-left-radius: 3px; }\n\n.paginationControl #listItem .ngx-pagination .pagination-next {\n    border-bottom-right-radius: 3px;\n    border-top-right-radius: 3px; }\n\n.paginationControl #listItem .ngx-pagination a {\n    color: #606c71; }\n\n.paginationControl #listItem .ngx-pagination a:hover {\n      background: transparent; }\n\n.paginationControl #listItem .ngx-pagination .disabled {\n    padding: 0.1875rem 0.625rem;\n    margin-left: 0.9px;\n    color: #cacaca;\n    cursor: not-allowed; }\n\n.paginationControl #listItem ul li {\n    border: 1px solid #d6d6d6;\n    margin-left: -2px;\n    height: 35px;\n    text-align: center;\n    min-width: 35px;\n    line-height: 27px; }\n\n.paginationControl #listItem ul li:hover {\n      background: transparent; }\n\n.paginationControl .pageControl {\n    cursor: pointer;\n    padding: 0 10px; }\n\n.paginationControl .pageControl ul {\n      padding: 10px 0;\n      margin: 0;\n      float: left; }\n\n.btn-danger {\n  margin-left: 3px; }\n\n.btn-primary {\n  margin-right: 3px; }\n\n.btn:hover {\n  -webkit-transform: none;\n          transform: none; }\n\n.fa-rupee:before, .fa-inr:before {\n  content: \"\\F156\";\n  margin-right: 14px !important; }\n\n.ion-edit:before {\n  content: \"\\F2BF\";\n  color: #000000; }\n\n.ion-trash-b:before {\n  content: \"\\F252\";\n  color: #ff0000; }\n\ntable th, table td {\n  border: 1px solid #ddd; }\n\ntable .ng2-smart-actions {\n  text-align: center;\n  color: #374767; }\n\ntable .ng2-smart-title a {\n  color: #374767; }\n\ntable .ng2-smart-title a:hover {\n  text-decoration: none; }\n\n.inputbox {\n  border-radius: 3px;\n  background-color: white;\n  width: 100%;\n  height: 100%;\n  margin-bottom: 0px;\n  padding-left: 2%;\n  border: 1px solid gainsboro;\n  outline: none;\n  -webkit-box-shadow: none;\n          box-shadow: none;\n  color: #666666; }\n\n.inputbox::-webkit-input-placeholder {\n  /* Chrome/Opera/Safari */\n  color: #666666; }\n\n.inputbox::-moz-placeholder {\n  /* Firefox 19+ */\n  color: #666666; }\n\n.inputbox:-ms-input-placeholder {\n  /* IE 10+ */\n  color: #666666; }\n\n.inputbox:-moz-placeholder {\n  /* Firefox 18- */\n  color: #666666; }\n\n.inputbox:focus, .inputbox:active {\n  border-color: #A5C9BB;\n  outline: 0;\n  outline: thin dotted \\9;\n  /* -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(82,168,236,.6); */\n  -webkit-box-shadow: inset 0 1px 1px rgba(0, 220, 0, 0.075), 0 0 8px rgba(0, 225, 0, 0.2);\n          box-shadow: inset 0 1px 1px rgba(0, 220, 0, 0.075), 0 0 8px rgba(0, 225, 0, 0.2); }\n\n.inputbutton {\n  line-height: 2.8;\n  margin: 3% 0 -2% 0; }\n\n.btnStyle {\n  width: 100%;\n  height: 100%;\n  background-color: #195C94;\n  color: white;\n  font-size: medium;\n  font-weight: bold;\n  border: none;\n  border-radius: 3px;\n  cursor: pointer; }\n\n.btnStyle:focus {\n    outline: none;\n    -webkit-box-shadow: 0px 0px 2px 2px #59a453;\n            box-shadow: 0px 0px 2px 2px #59a453; }\n\n.passwordErrorMessage {\n  float: left;\n  margin-top: -35px;\n  width: 100%;\n  margin-bottom: 10px; }\n\n.divAlignLeft {\n  float: left; }\n\n.divAlignRight {\n  float: right; }\n\n.Quotedatepicker .mydp .currmonth:hover {\n  background-color: #59a453 !important; }\n\n.Quotedatepicker .mydp .selector {\n  z-index: 1;\n  boder-radius: 3px; }\n\n.Quotedatepicker .mydp .selection {\n  height: 33px !important;\n  color: #757575;\n  font-size: 15px !important;\n  position: relative;\n  text-align: left;\n  padding-left: 8px;\n  boder-radius: 3px; }\n\n.Quotedatepicker .mydp .selbtngroup {\n  height: 33px !important; }\n\n.Quotedatepicker .mydp .btnclear {\n  color: #757575; }\n\n.Quotedatepicker .mydp .btnclear:hover {\n  background-color: #59a453 !important; }\n\n.Quotedatepicker .mydp .btnpicker {\n  height: 33px !important; }\n\n.Quotedatepicker .mydp .btnclearenabled:hover {\n  background-color: #5fbe7e;\n  color: #fff; }\n\n.Quotedatepicker .mydp .btnpicker {\n  color: #757575; }\n\n.Quotedatepicker .mydp .btnpicker:hover {\n  background-color: #59a453 !important; }\n\n.Quotedatepicker .mydp .btnpickerenabled:hover {\n  background-color: #5fbe7e;\n  color: #fff; }\n\n.Quotedatepicker .help-block {\n  color: red; }\n\nrl-tag-input-item {\n  margin-bottom: 3px; }\n\nrl-tag-input input {\n  font-family: 'Conv_Avenir' !important; }\n\nrl-tag-input input::-webkit-input-placeholder {\n  color: grey; }\n\nrl-tag-input-item {\n  font-family: 'Conv_Avenir' !important; }\n\n.resetPasswordContainer {\n  text-align: center; }\n\n.resetPasswordContainer .resetPasswordSegment {\n    width: 28%;\n    display: inline-block; }\n\n.resetPasswordContainer .resetPasswordSegment .resetdivStyle {\n      text-align: center;\n      font-size: 17px;\n      font-weight: 500;\n      letter-spacing: 0.005em; }\n\n.resetPasswordContainer .resetPasswordSegment .resetTitle {\n      width: 100%;\n      display: inline-block;\n      margin-top: 15%; }\n\n.resetPasswordContainer .resetPasswordSegment .resetTitle img {\n        width: 60%; }\n\n.resetPasswordContainer .resetPasswordSegment .signup {\n      border: 1px solid gainsboro;\n      background-color: #fff;\n      border-radius: 3px;\n      margin-top: 10px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .resetdivStyle {\n        text-align: center;\n        font-size: 17px;\n        margin-top: 5%;\n        margin-bottom: 16px;\n        font-weight: 500;\n        letter-spacing: 0.005em; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .resetdivStyle .sign-up-input {\n          height: 95%; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .right-border {\n        border-bottom-right-radius: 3px;\n        border-top-right-radius: 3px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .input-group .input-group-addon {\n        border-bottom-left-radius: 3px;\n        border-top-left-radius: 3px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .submitButton {\n        margin-top: 5%;\n        cursor: pointer; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .signUpText {\n        width: 80%;\n        margin: 0 auto;\n        margin-top: 7.8%;\n        font-size: 17px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .disableSubmit {\n        opacity: 0.8;\n        cursor: not-allowed; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .disableSubmit:hover {\n          opacity: 0.8;\n          cursor: not-allowed; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .signIn {\n        cursor: pointer;\n        color: #59a453;\n        font-size: 15px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .signIn:hover {\n          text-decoration: underline; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .signInText {\n        font-size: 15px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .help-block {\n        color: red; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .sub-little-text {\n        font-size: 12px; }\n\n.resetPasswordContainer .resetPasswordSegment .signup .alreadyHaveAccount {\n        margin-bottom: 5%; }\n\n.resetPasswordContainer .resetPasswordSegment .signUpErrorMessage {\n      float: left;\n      margin-top: -35px;\n      width: 100%; }\n\n.resetPasswordContainer .resetPasswordSegment .sub-little-signUp-error {\n      font-size: 12px; }\n\n.resetPasswordContainer .resetPasswordSegment a {\n      color: #59a453; }\n\n.resetPasswordContainer .resetPasswordSegment .forgotPassword {\n      cursor: pointer;\n      font-size: 17px;\n      color: #59a453; }\n\n.resetPasswordContainer .resetPasswordSegment .forgotPassword:hover {\n        text-decoration: underline; }\n\n@media screen and (min-width: 200px) and (max-width: 700px) {\n  .resetPasswordSegment {\n    width: 100%; }\n  .horizontalLine {\n    display: inline-block;\n    width: 35%; }\n    .horizontalLine hr {\n      margin-top: -4px;\n      margin-bottom: 0; }\n  .signUpText {\n    display: inline-block;\n    width: 27%;\n    padding: 0; } }\n\n@media only screen and (min-device-width: 768px) and (max-device-width: 1024px) {\n  .resetPasswordSegment {\n    width: 60% !important; }\n  .signUpText {\n    display: inline-block;\n    width: 27%; } }\n\n@media screen and (min-width: 200px) and (max-width: 700px) {\n  .resetPasswordSegment {\n    width: 100% !important; }\n  .signUpText {\n    display: inline-block;\n    width: 27%;\n    padding: 0; } }\n\n@media screen and (min-width: 200px) and (max-width: 700px) {\n  .resetPasswordSegment {\n    width: 100% !important; }\n  .signUpText {\n    display: inline-block;\n    width: 27%;\n    padding: 0; } }\n"
