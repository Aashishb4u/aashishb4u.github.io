webpackJsonp(["editAlmirah.module"],{

/***/ "../../../../../src/app/pages/editAlmirah/editAlmirah.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return editAlmirah; });
...
var editAlmirah = (function () {
    function editAlmirah(fb, routes, userUtility, router, authentication, appService, toastr, vRef, _spinner) {
        this.fb = fb;
        this.routes = routes;
    ...
    editAlmirah.prototype.addItemLocationSuccess = function (res) {
        if (res.status < 0) {
    ...
    editAlmirah.prototype.makeItCapital = function (data) {
        return data.replace(/\w\S*/g, function (txt) {
            return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();
        });
    };
    // get API to get all tags from tags table.
    editAlmirah.prototype.editItemLocation = function (values) {
        var _this = this;
        var data = {
            id: this.almirahId,
        ...
        this._spinner.show();
        // Api call to get categories, if success getDataSuccess(data) and if error getDataFail(error)
        this.appService.editItemLocation(data).subscribe(function (data) { return _this.addItemLocationSuccess(data); }, function (error) { return _this.getDataFail(error); });
    };
    // getVendorTags - Success
    editAlmirah.prototype.getDataSuccess = function (res) {
        if (res.status < 0) {
            this.toastr.error(this.userUtility.errorMessages['GET_TAGS_FAILED']);
        }
        else {
    ...
    // getVendorTags - Fail
    editAlmirah.prototype.getDataFail = function (error) {
        this._spinner.hide();
    ...
    // set up form.
    editAlmirah.prototype.userBasicInfo = function () {
    ...
    editAlmirah.prototype.selectLocation = function (event) {
        this.locationSelected = event.target.value;
    };
    // submission of add user form.
    editAlmirah.prototype.onSubmit = function (value) {
        var _this = this;
        this._spinner.show();
    ...
    editAlmirah.prototype.addNewVendorSuccess = function (result) {
        if (result.status < 0) {
    ...
    editAlmirah.prototype.addNewVendorFail = function (error) {
        this._spinner.hide();
        if (error.error && error.error.message) {
            this.toastr.error(error.error.message);
        }
...
], editAlmirah.prototype, "firstField", void 0);
editAlmirah = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'editAlmirah',
        styles: [__webpack_require__("../../../../../src/app/pages/editAlmirah/editAlmirah.scss")],
        template: __webpack_require__("../../../../../src/app/pages/editAlmirah/editAlmirah.html"),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__editAlmirah_component__ = __webpack_require__("../../../../../src/app/pages/editAlmirah/editAlmirah.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__editAlmirah_routing__ = __webpack_require__("../../../../../src/app/pages/editAlmirah/editAlmirah.routing.ts");
...
var editAlmirahModule = (function () {
    function editAlmirahModule() {
    }
    return editAlmirahModule;
}());
editAlmirahModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__editAlmirah_routing__["a" /* routing */],
            __WEBPACK_IMPORTED_MODULE_2__angular_forms__["ReactiveFormsModule"],
            __WEBPACK_IMPORTED_MODULE_6_angular2_text_mask__["TextMaskModule"]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__editAlmirah_component__["a" /* editAlmirah */]
        ],
        providers: []
    })
], editAlmirahModule);

//# sourceMappingURL=editAlmirah.module.js.map

/***/ }),

/***/ "../../../../../src/app/pages/editAlmirah/editAlmirah.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editAlmirah_component__ = __webpack_require__("../../../../../src/app/pages/editAlmirah/editAlmirah.component.ts");


var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__editAlmirah_component__["a" /* editAlmirah */],
        children: []
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["RouterModule"].forChild(routes);
//# sourceMappingURL=editAlmirah.routing.js.map

/***/ }),

/***/ "../../../../../src/app/pages/editAlmirah/editAlmirah.scss":
...
//# sourceMappingURL=editAlmirah.module.chunk.js.map