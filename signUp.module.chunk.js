...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__theme_validators__ = __webpack_require__("../../../../../src/app/theme/validators/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__theme_validators_blank_validator__ = __webpack_require__("../../../../../src/app/theme/validators/blank.validator.ts");
...
var signUp = (function (_super) {
    ...
    function signUp(fb, router, appService, toastr, vRef, _spinner) {
        ...
        _this.form = fb.group({
            'firstName': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_6__theme_validators_blank_validator__["a" /* BlankSpaceValidator */].validate])],
            'lastName': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_6__theme_validators_blank_validator__["a" /* BlankSpaceValidator */].validate])],
            'email': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_5__theme_validators__["a" /* EmailValidator */].validate])],
        });
        return _this;
    }
    signUp.prototype.ngAfterViewInit = function () {
    ...
    signUp.prototype.onSubmit = function (value) {
        ...
        this.appService.userSignUp(signUpData).subscribe(function (data) { return _this.signUpSuccess(data); }, function (error) { return _this.signUpFail(error); });
    };
    /**
     * if signup success
     * @param data
     */
    signUp.prototype.signUpSuccess = function (data) {
        if (data) {
            this._spinner.hide();
