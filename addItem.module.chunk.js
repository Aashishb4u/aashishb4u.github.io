webpackJsonp(["addItem.module"],{

/***/ "../../../../../src/app/pages/addItem/addItem.component.ts":
...
var addItem = (function () {
    function addItem(fb, userUtility, router, authentication, appService, toastr, vRef, _spinner) {
        this.fb = fb;
    ...
    // Initiating Angular
    addItem.prototype.ngOnInit = function () {
        this.userBasicInfo();
        this.getVendorTags();
    ...
    addItem.prototype.goBack = function () {
        this.router.navigate(['/viewItems']);
    };
    // get API to get all tags from tags table.
    addItem.prototype.getVendorTags = function () {
        var _this = this;
        this._spinner.show();
    ...
    addItem.prototype.getDataSuccess = function (res) {
        var _this = this;
        if (res.status < 0) {
            ...
            res.data[0].forEach(function (item) {
                _this.tagsArray.push(item.name); // Array used to show all categories.
            });
        }
    };
    // getVendorTags - Fail
    addItem.prototype.getDataFail = function (error) {
        this._spinner.hide();
    ...
    // get API to get all tags from tags table.
    addItem.prototype.getItemLocation = function () {
        var _this = this;
        this._spinner.show();
        // Api call to get categories, if success getDataSuccess(data) and if error getDataFail(error)
    ...
    // getVendorTags - Success
    addItem.prototype.getAllLocationsSuccess = function (res) {
        var _this = this;
        this._spinner.hide();
        if (res.status < 0) {
    ...
    addItem.prototype.changeTab = function (id) {
        var toggleName = id;
        switch (toggleName) {
    ...
    // set up form.
    addItem.prototype.userBasicInfo = function () {
        this.form = this.fb.group({
            'vendorName': this.fb.control('', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required])),
            ...
            'location': this.fb.control('', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([])),
    ...
    addItem.prototype.selectLocation = function (event) {
        this.locationSelected = event.target.value;
    };
    // submission of add user form.
    addItem.prototype.onSubmit = function (value) {
        var _this = this;
        this._spinner.show();
    ...
    addItem.prototype.addNewVendorSuccess = function (result) {
        if (result.status < 0) {
    ...
    addItem.prototype.addNewVendorFail = function (error) {
        this._spinner.hide();
        if (error.error && error.error.message) {
            this.toastr.error(error.error.message);
        }
...
], addItem.prototype, "firstField", void 0);
addItem = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'addItem',
        styles: [__webpack_require__("../../../../../src/app/pages/addItem/addItem.scss")],
        template: __webpack_require__("../../../../../src/app/pages/addItem/addItem.html"),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__addItem_component__ = __webpack_require__("../../../../../src/app/pages/addItem/addItem.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addItem_routing__ = __webpack_require__("../../../../../src/app/pages/addItem/addItem.routing.ts");
...
addItemModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__addItem_routing__["a" /* routing */],
            __WEBPACK_IMPORTED_MODULE_2__angular_forms__["ReactiveFormsModule"],
            __WEBPACK_IMPORTED_MODULE_6_angular2_text_mask__["TextMaskModule"]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__addItem_component__["a" /* addItem */]
        ],
        providers: []
    })
], addItemModule);
...
/***/ "../../../../../src/app/pages/addItem/addItem.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addItem_component__ = __webpack_require__("../../../../../src/app/pages/addItem/addItem.component.ts");


var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__addItem_component__["a" /* addItem */],
        children: []
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["RouterModule"].forChild(routes);
//# sourceMappingURL=addItem.routing.js.map

/***/ }),

/***/ "../../../../../src/app/pages/addItem/addItem.scss":
...
//# sourceMappingURL=addItem.module.chunk.js.map