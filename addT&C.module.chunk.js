webpackJsonp(["addT&C.module"],{

/***/ "../../../../../src/app/pages/addT&C/addT&C.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addTermsAndCondition; });
...
var addTermsAndCondition = (function () {
    function addTermsAndCondition(fb, userUtility, router, authentication, appService, toastr, vRef, _spinner) {
        this.fb = fb;
    ...
    // Initiating Angular
    addTermsAndCondition.prototype.ngOnInit = function () {
        this.getVendorTags();
    };
    // function called after cancelbutton is clicked.
    addTermsAndCondition.prototype.goBack = function () {
        this.router.navigate(['/viewTermsAndConditions']);
    };
    // function called when add Terms button is clicked.
    addTermsAndCondition.prototype.addTerms = function () {
        var _this = this;
        var termsData = {
        ...
        this.appService.addTermsCondition(termsData).subscribe(function (data) { return _this.addTermsConditionSuccess(data); }, function (error) { return _this.addTermsConditionFail(error); });
    };
    // get API to get all tags from tags table.
    addTermsAndCondition.prototype.getVendorTags = function () {
        var _this = this;
        this._spinner.show();
    ...
    addTermsAndCondition.prototype.getDataSuccess = function (res) {
        var _this = this;
        this._spinner.hide();
        this.tagsArray = []; // Array is flushed before use.
        res.data[0].forEach(function (item) {
            _this.tagsArray.push(item); // Array used to show all categories.
        });
    };
    // getVendorTags - Fail
    addTermsAndCondition.prototype.getDataFail = function (res) {
        this._spinner.hide();
    ...
    addTermsAndCondition.prototype.addTermsConditionSuccess = function (result) {
        if (result.status < 0) {
    ...
    addTermsAndCondition.prototype.addTermsConditionFail = function (error) {
        this._spinner.hide();
    ...
    return addTermsAndCondition;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])('vendorName'),
    __metadata("design:type", Object)
], addTermsAndCondition.prototype, "firstField", void 0);
addTermsAndCondition = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'addTermsAndCondition',
        styles: [__webpack_require__("../../../../../src/app/pages/addT&C/addT&C.scss")],
        template: __webpack_require__("../../../../../src/app/pages/addT&C/addT&C.html"),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__addT_C_component__ = __webpack_require__("../../../../../src/app/pages/addT&C/addT&C.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addT_C_routing__ = __webpack_require__("../../../../../src/app/pages/addT&C/addT&C.routing.ts");
...
var addTermsAndConditionModule = (function () {
    function addTermsAndConditionModule() {
    }
    return addTermsAndConditionModule;
}());
addTermsAndConditionModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__addT_C_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__addT_C_component__["a" /* addTermsAndCondition */]
        ],
        providers: []
    })
], addTermsAndConditionModule);

//# sourceMappingURL=addT&C.module.js.map

/***/ }),

/***/ "../../../../../src/app/pages/addT&C/addT&C.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addT_C_component__ = __webpack_require__("../../../../../src/app/pages/addT&C/addT&C.component.ts");


var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__addT_C_component__["a" /* addTermsAndCondition */],
        children: []
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["RouterModule"].forChild(routes);
//# sourceMappingURL=addT&C.routing.js.map

/***/ }),

/***/ "../../../../../src/app/pages/addT&C/addT&C.scss":
...
//# sourceMappingURL=addT&C.module.chunk.js.map