...
var forgotPassword = (function (_super) {
    ...
    function forgotPassword(fb, router, appService, toastr, vRef, _spinner, authentication) {
        ...
        _this.form = fb.group({
            'email': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_6__theme_validators_email_validator__["a" /* EmailValidator */].validate])],
        });
        return _this;
    }
