webpackJsonp(["editT&C.module"],{

/***/ "../../../../../src/app/pages/editT&C/editT&C.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return editTermsAndCondition; });
...
var editTermsAndCondition = (function () {
    function editTermsAndCondition(fb, userUtility, router, routes, authentication, appService, toastr, vRef, _spinner) {
        this.fb = fb;
    ...
    editTermsAndCondition.prototype.ngOnInit = function () {
        this.getVendorTags();
    };
    editTermsAndCondition.prototype.ngAfterViewInit = function () {
        this.getTermsById();
    };
    editTermsAndCondition.prototype.goBack = function () {
        this.router.navigate(['/viewTermsAndConditions']);
    };
    editTermsAndCondition.prototype.editTerms = function () {
        var _this = this;
        var termsData = {
        ...
        this.appService.editTermsCondition(termsData).subscribe(function (data) { return _this.addNewVendorSuccess(data); }, function (error) { return _this.addNewVendorFail(error); });
    };
    editTermsAndCondition.prototype.getVendorTags = function () {
        var _this = this;
        this._spinner.show();
    ...
    editTermsAndCondition.prototype.getTermsById = function () {
        var _this = this;
        this._spinner.show();
        var data = {
            id_term: this.termId
        };
        this.appService.getTermsById(data).subscribe(function (data) { return _this.getTermsByIdSuccess(data); }, function (error) { return _this.getTermsByIdFail(error); });
    };
    editTermsAndCondition.prototype.getDataSuccess = function (res) {
        var _this = this;
        this._spinner.hide();
        this.tagsArray = [];
    ...
    editTermsAndCondition.prototype.getTermsByIdSuccess = function (res) {
        var _this = this;
        this.preTagsData = [];
        this._spinner.hide();
        res.data[0][0].forEach(function (val) {
            _this.preTagsData.push(val.id.toString());
        });
        this.description = res.data[0][1][0].terms;
        this.categoryData = Array.from(this.preTagsData);
    };
    editTermsAndCondition.prototype.checkValue = function (data) {
        var _this = this;
        this.deleteArray = [];
        this.preTagsData.forEach(function (val) {
            if (_this.categoryData.indexOf(val) === -1) {
                _this.deleteArray.push(val);
            }
        });
    };
    editTermsAndCondition.prototype.getDataFail = function (res) {
        this._spinner.hide();
    ...
    editTermsAndCondition.prototype.getTermsByIdFail = function (res) {
        this._spinner.hide();
        if (res.error && res.error.message) {
            this.toastr.error(res.error.message);
        }
    ...
    // }
    // set up form.
    editTermsAndCondition.prototype.addCandidatetags = function (event) {
    };
    editTermsAndCondition.prototype.removeCandidatetags = function (event) {
    };
    // if edit profile success
    editTermsAndCondition.prototype.addNewVendorSuccess = function (result) {
        if (result.status < 0) {
    ...
    editTermsAndCondition.prototype.addNewVendorFail = function (error) {
        this._spinner.hide();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__editT_C_component__ = __webpack_require__("../../../../../src/app/pages/editT&C/editT&C.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__editT_C_routing__ = __webpack_require__("../../../../../src/app/pages/editT&C/editT&C.routing.ts");
...
var editTermsAndConditionModule = (function () {
    function editTermsAndConditionModule() {
    }
    return editTermsAndConditionModule;
}());
editTermsAndConditionModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__editT_C_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__editT_C_component__["a" /* editTermsAndCondition */]
        ],
        providers: []
    })
], editTermsAndConditionModule);

//# sourceMappingURL=editT&C.module.js.map

/***/ }),

/***/ "../../../../../src/app/pages/editT&C/editT&C.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editT_C_component__ = __webpack_require__("../../../../../src/app/pages/editT&C/editT&C.component.ts");


var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__editT_C_component__["a" /* editTermsAndCondition */],
        children: []
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["RouterModule"].forChild(routes);
//# sourceMappingURL=editT&C.routing.js.map

/***/ }),

/***/ "../../../../../src/app/pages/editT&C/editT&C.scss":
...
//# sourceMappingURL=editT&C.module.chunk.js.map